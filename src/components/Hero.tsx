...
export default function Hero() {
  const words = ["Printing & ATK", "Fotocopy & Jilid", "Digital Printing","Hardcover","Softcover","Jilid Spiral","Sticker & ID Card"];
          ...
          >
            <Link href="/kalkulator" passHref legacyBehavior>
              <motion.a
                ...
                whileTap={{ scale: 0.95 }}
                className="inline-flex items-center justify-center rounded-full bg-[#25D366] hover:bg-[#20BA5C] text-white px-8 py-3 font-mono text-xs font-bold uppercase tracking-widest transition-all duration-300 cursor-pointer"
              >
